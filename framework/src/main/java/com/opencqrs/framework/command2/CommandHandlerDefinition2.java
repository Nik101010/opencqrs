 ...
 */
public record CommandHandlerDefinition2<I, C extends Command, R>(
        Class<I> instanceClass, Class<C> commandClass, CommandHandler<I, C, R> handler, CommandHandlingMode commandHandlingMode) {
     ...
     */
    public CommandHandlerDefinition2(
            Class<I> instanceClazz, Class<C> commandClazz, CommandHandler<I, C, R> commandHandler) {
        this(instanceClazz, commandClazz, commandHandler, new CommandHandlingMode.Subject());
    }
}
